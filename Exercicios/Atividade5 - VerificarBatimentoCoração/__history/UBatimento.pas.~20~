...
begin
  ...
  case xVerificar of
    0..39:
      Result:= ('Como vc não esta morto ? ' + IntToStr(xVerificar) + ' BPM');
    40..59:
      Result:= ('Coração esta lento com: ' + IntToStr(xVerificar) + ' BPM' );
    60..100:
      Result:= ('Coração esta batendo normalmente com: ' + IntToStr(xVerificar) + ' BPM');
    101..200:
      Result:= ('Coração esta acelerado com: ' + IntToStr(xVerificar) + ' BPM');
    201..10000:
